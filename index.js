...
async function handleHost(interaction) {
    try {
        ...
        console.error('Error handling host command:', error);
        await interaction.reply({ content: 'An error occurred while handling the host command. Please try again later.', ephemeral: true });
    }
}
//Inputs for Delay Command
async function handleDelay(interaction) {
    try {
        ...
        console.error('Error handling delay command:', error);
        await interaction.reply({ content: 'An error occurred while handling the delay command. Please try again later.', ephemeral: true });
    }
}
...
async function handleCancel(interaction) {
    try {
        ...
        await interaction.reply({ content: 'An error occurred while handling the cancel command. Please try again later.', ephemeral: true });
    }
}
//Inputs for DM Command
async function handleDM(interaction) {
    try {
        ...
        await interaction.reply({ content: 'An error occurred while handling the DM command. Please try again later.', ephemeral: true });
    }
}
...
async function handleStart(interaction) {
    try {
        ...
        await interaction.reply({ content: 'An error occurred while handling the start command. Please try again later.', ephemeral: true });
    }
}

//The functions when you pressed ok at every input panel
    ...
    try {
        if (interaction.customId === 'host_modal') {
            ...
            if (publicChannel) {
                ...
                await publicChannel.send({ embeds: [startEmbed] });
            }
        ...
        await interaction.reply({ content: 'An error occurred while handling the modal submission. Please try again later.', ephemeral: true });
    }
}
